...
def get_input_args():
    ...
    #Argument 2: That's the architectural model to choose
    parser.add_argument('--arch', type = str, default = 'vgg', help = 'CNN Model Architecture to choose between resnet, alexnet or vgg')
    ...
    in_args = parser.parse_args(None)
